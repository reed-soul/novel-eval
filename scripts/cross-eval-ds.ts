/**
 * 交叉评估脚本 — 用 DeepSeek 评估器重新评价 DeepSeek 版章节
 *
...
// GLM 版项目 ID
const GLM_PID = 'dd4e3516-5fe9-407e-ad50-ec8c4b69f59b';
...
async function main() {
  console.log('═══════════════════════════════════════════════');
  console.log('  交叉评估：DeepSeek 评估器 → DeepSeek 版章节');
  console.log('═══════════════════════════════════════════════\n');
  ...
  console.log(`\n（对比：DeepSeek 自评平均约 78 分，A 级约 90%）`);
